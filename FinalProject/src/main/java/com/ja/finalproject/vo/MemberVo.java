...
public class MemberVo {
	...
	@DateTimeFormat(pattern = "yyyy-MM-dd") // 왼쪽 패턴에 해당하는 파라미터 문자를 수욯아게 한다.
	private String member_birth; // 2021/01/01 x.. 2021-01-01 O...
	...
	public MemberVo(int member_no, String member_id, String member_pw, String member_nick, String member_gender,
			String member_birth, String member_phone, String member_email, String member_joindate) {
		super();
